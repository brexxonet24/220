<?php include 'header.php'; ?>
    ...
    <div class="container">    
        <form class="form" method="post" action="listar_usuarios.php">
            Nombre:<input class="form-control" type="text" name="texto1" id="texto1" required>
            Email:<input class="form-control" type="email" name="texto2" id="texto2" required>
            Password:<input class="form-control" type="password" name="texto3" id="texto3" required><br/>
