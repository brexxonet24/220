...
<body>
    ...
    <div class="container">    
        <form class="form" method="post" action="listar.php">
            ...
            Password:<input class="form-control" type="email" name="texto2" id="texto2" required><br/>
            Email:<input class="form-control" type=password" name="texto3" id="texto3" required><br/>
